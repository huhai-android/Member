...
import com.newdjk.member.ui.entity.JPushDataMessageEntity;
...
//                processCustomMessage(context, bundle);
                ...
                String id =  jPushDataMessageEntity.getUserId();
                SQLiteUtils.getInstance().addPushData(new PushDataDaoEntity(null,title,content,data,curDate,isRead,id,jPushDataMessageEntity.getMsgType(),jPushDataMessageEntity.getModuleType(),jPushDataMessageEntity.getId()));
                MessageEvent event = new MessageEvent();
                event.setmType(MainConstant.UPDATEPUSHMESSAGELIST);
