package com.newdjk.member.camera;

import android.net.Uri;
import android.text.TextUtils;
import android.util.Log;

import com.huhai.videorecode.DateTimeUtil;
import com.huhai.videorecode.FileUtil;
import com.huhai.videorecode.ImageUtil;
...
public class MessageInfoUtil {
    ...
    public static MessageInfo TIMMessage2MessageInfo(TIMMessage timMessage, boolean isGroup) {
        ...
        if (timMessage.getElementCount() > 0) {
            ...
            if (ele == null) {
                Log.e("MessageInfoUtil", "msg found null elem");
                return null;
            }

            TIMElemType type = ele.getType();
            if (type == TIMElemType.Invalid) {
                Log.e("MessageInfoUtil", "invalid");
                return null;
            }
                        ...
                        if (!file.exists()) {
                            soundElemEle.getSoundToFile(path, new TIMCallBack() {
                                ...
                                public void onError(int code, String desc) {
                                    Log.e("MessageInfoUtil", code + ":" + desc);
                                }
            ...
            Log.e("MessageInfoUtil", "msg elecount is 0");
            return null;
        }
