...
import com.newdjk.member.ui.adapter.TabChatAdapter;
 ...
 *  @描述：
 */
public class TabChatFragment extends BasicFragment {
    ...
    private TabChatAdapter mFunctionAdapter;
    ...
    protected void initView() {
        ...
        mFunctionAdapter = new TabChatAdapter(listall);
    ...
    public static TabChatFragment getFragment() {
