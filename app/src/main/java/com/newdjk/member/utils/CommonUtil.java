...
public class CommonUtil {
	...
	public static void call(Activity context, String phone) {
		if (StrUtil.isNotEmpty(phone, true)) {
	...
	public static void toMessageChat(Activity context, String phone){
		if (context == null || StrUtil.isNotEmpty(phone, true) == false) {
			Log.e(TAG, "sendMessage  context == null || StrUtil.isNotEmpty(phone, true) == false) >> return;");
			return;
		}
	...
	public static void shareInfo(Activity context, String toShare) {
		if (context == null || StrUtil.isNotEmpty(toShare, true) == false) {
			Log.e(TAG, "shareInfo  context == null || StrUtil.isNotEmpty(toShare, true) == false >> return;");
			return;
		}
	...
	public static void sendEmail(Activity context, String emailAddress) {
		if (context == null || StrUtil.isNotEmpty(emailAddress, true) == false) {
			Log.e(TAG, "sendEmail  context == null || StrUtil.isNotEmpty(emailAddress, true) == false >> return;");
			return;
		}
	...
	public static void openWebSite(Activity context, String webSite) {
		if (context == null || StrUtil.isNotEmpty(webSite, true) == false) {
			Log.e(TAG, "openWebSite  context == null || StrUtil.isNotEmpty(webSite, true) == false >> return;");
			return;
		}

		toActivity(context, new Intent(Intent.ACTION_VIEW, Uri.parse(StrUtil.getCorrectUrl(webSite))));
	}
	...
	public static void copyText(Context context, String value) {
		if (context == null || StrUtil.isNotEmpty(value, true) == false) {
			Log.e(TAG, "copyText  context == null || StrUtil.isNotEmpty(value, true) == false >> return;");
			return;
		}
	...
	public static String savePhotoToSDCard(String path, String photoName, String formSuffix, Bitmap photoBitmap) {
		if (photoBitmap == null || StrUtil.isNotEmpty(path, true) == false 
				|| StrUtil.isNotEmpty(StrUtil.getTrimedString(photoName)
						+ StrUtil.getTrimedString(formSuffix), true) == false) {
			Log.e(TAG, "savePhotoToSDCard photoBitmap == null || StrUtil.isNotEmpty(path, true) == false" +
					"|| StrUtil.isNotEmpty(photoName, true) == false) >> return null" );
			return null;
		}
