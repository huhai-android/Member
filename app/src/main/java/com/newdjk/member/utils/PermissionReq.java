...
public class PermissionReq {
    ...
    private static boolean flag = false;//判断是否允许了权限
     ...
     * @return
     */
    public static boolean permission(Activity activity, String... permissions) {
//        Manifest.permission.CAMERA,
//        Manifest.permission.WRITE_EXTERNAL_STORAGE
        flag = false;
        PermissionReq.with(activity).permissions(
                permissions)
                .result(new Result() {
                    @Override
