...
public class StrUtil {
    ...
    public static int getInt(Object object) {
        return getInt(object == null ? "" : getString(String.valueOf(object)));
    }
     ...
     * @return
     */
    public static int getInt(CharSequence cs) {
        return getInt(cs == null ? "" : getString(cs.toString()));
    }
     ...
     * @return
     */
    public static double getDouble(CharSequence cs) {
        return getDouble(cs == null ? "" : getString(cs.toString()));
    }
    ...
    public static boolean isNotEmpty(TextView tv, boolean trim) {
        return isNotEmpty(getString(tv.getText()), trim);
    }
    ...
    public static boolean isNotEmpty(EditText et, boolean trim) {
        return isNotEmpty(getString(et.getText()), trim);
    }
    ...
    public static boolean isMobile(String mobileNums) {
        ...
        String telRegex = "^((13[0-9])|(14[5,7,9])|(15[^4])|(16[6])|(17[0,1,3,5,6,7,8])|(18[0-9])|(19[8,9]))\\d{8}$";
    ...
    public static boolean isFilePathExist(String path) {
        return StrUtil.isFilePath(path) && new File(path).exists();
    }
...
//		}
    ...
    public static String getPriceY(double price) {
        return getPrice(price, PRICE_FORMAT_SUFFIX);
    }
    public static String getPriceY(String price) {
        return getPrice(price, PRICE_FORMAT_SUFFIX);
    }

    public static String getPriceF(double price) {
        return getPrice(price, PRICE_FORMAT_PREFIX);
    }
    ...
    public static String getPrice(String price) {
        return getPrice(price, PRICE_FORMAT_PREFIX_WITH_BLANK);
    }
