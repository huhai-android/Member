 ...
 * 自定义图片，显示圆形图片
 */
public class CircleImageView1 extends android.support.v7.widget.AppCompatImageView {
	...
	private static final int DEFAULT_BORDER_COLOR =  0xFF0ca0a0;
	...
	public CircleImageView1(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.CircleImageView1, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.CircleImageView1_civ_border_width,
				DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.CircleImageView1_civ_border_color,
				DEFAULT_BORDER_COLOR);
		mBorderOverlay = a.getBoolean(
				R.styleable.CircleImageView1_civ_border_overlay,
				DEFAULT_BORDER_OVERLAY);
		mFillColor = a.getColor(R.styleable.CircleImageView1_civ_fill_color,
				DEFAULT_FILL_COLOR);
		a.recycle();
		init();
	}
	...
	private void init() {
		...
		mReady = true;
		setBorderColorResource(R.color.tm);//设置边框颜色，
		setFillColorResource(R.color.tm);//设置填充颜色，
		setBorderWidth(0);//设置边框宽度
		if (mSetupPending) {
			setup();
			mSetupPending = false;
		}
...
//					InputStream is = r.openRawResource(R.drawable.app_logoimg);
