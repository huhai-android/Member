...
/**
 * Created by jakcy on 2018/04/23
 */
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.user_note_dialog_text1));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.user_note_dialog_text2));
    }
