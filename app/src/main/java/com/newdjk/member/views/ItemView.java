...
public class ItemView extends RelativeLayout {
    ...
    private void initView() {
        ...
        this.view = inflater.inflate(R.layout.common_item_view, (ViewGroup)null);
        if(this.view != null) {
    ...
    public void setLeftTextDrawableLeft(Drawable drawable, String itemString) {
        if(drawable != null) {
            ...
            this.getTvItemLeftText().setCompoundDrawables(drawable, (Drawable)null, (Drawable)null, (Drawable)null);
        } else {
            this.getTvItemLeftText().setCompoundDrawables((Drawable)null, (Drawable)null, (Drawable)null, (Drawable)null);
        }
    ...
    public void setRightTexticon(Drawable drawable) {
        if(drawable != null) {
            drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
            this.getTvItemRightText().setCompoundDrawables(drawable, (Drawable)null, (Drawable)null, (Drawable)null);
        } else {
            this.getTvItemRightText().setCompoundDrawables((Drawable)null, (Drawable)null, (Drawable)null, (Drawable)null);
        }
