...
public class JustifyTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public
    static final String TWO_CHINESE_BLANK = " ";
    ...
    private void drawScaledText(Canvas canvas, int
            lineStart, String line, float
                                        lineWidth) {
    ...
    private boolean isFirstLineOfParagraph(int
