...
public class TextViewEditText extends AppCompatEditText {
    ...
    public TextViewEditText(Context context, AttributeSet attrs) {
        super(context, attrs);

        initView(context, attrs);
    }

    public TextViewEditText(Context context, AttributeSet attrs, int defStyle) {
