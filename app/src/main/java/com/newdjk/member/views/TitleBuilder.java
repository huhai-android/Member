...
public class TitleBuilder {
    ...
    public TitleBuilder(Activity context) {
        rootView = context.findViewById(R.id.liear_titlebar);
        if (rootView == null) {
            return;
        }
        tvTitle = (TextView) rootView.findViewById(R.id.top_title);
        ivLeft = (ImageView) rootView.findViewById(R.id.top_left);
        ivRight = (ImageView) rootView.findViewById(R.id.top_right);
    ...
    public TitleBuilder setTitleTextColor(int color) {
        tvTitle.setTextColor(MyApplication.getContext().getResources().getColor(color));
        return this;
    }
