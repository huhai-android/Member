...
//
        ...
        if (onBaseItemClick2 != null) {
            setListener2(view, pos);
        }
     ...
     * @param position
     */
    private void setListener2(View view, final int position) {
        if (view == null) {
            return;
        }
        ...
        view.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onBaseItemClick2.onItemClick(configAttrs.getValueList().get(position), position);
            }
        });
    }
    ...
    public void setOnBaseItemClick(OnBaseItemClick2 onBaseItemClick) {
        this.onBaseItemClick2 = onBaseItemClick;
        setOnClick();
    }
