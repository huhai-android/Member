...
public class ItemView extends RelativeLayout {
    ...
    public void setShowStyle(BaseItemView.Mode mode){

        hideRightAllType();

        if(mode == null){
            mode = BaseItemView.Mode.DEFAULT;
        }
        if(mode == BaseItemView.Mode.IMAGE){
            arrowImg.setVisibility(VISIBLE);
        }else if(mode == BaseItemView.Mode.TXT){
            rightTextView.setVisibility(VISIBLE);
        }else if(mode == BaseItemView.Mode.BUTTON){
    ...
    private void hideRightAllType() {
     ...
     private BaseItemView.OnSwitchClickListener onSwitchClickListener;

    public BaseItemView.OnSwitchClickListener getOnSwitchClickListener() {
