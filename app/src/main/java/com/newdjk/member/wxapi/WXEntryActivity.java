...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    public static void loginWeixin(Context context, IWXAPI api) {
        ...
        api.sendReq(req);
        LoadDialog.show(MyApplication.getContext());
    }
...
//        WXResp wxResp = mGson.fromJson(response, WXResp.class);
//        if (TextUtils.isEmpty(wxResp.getErrmsg())) {
//            return false;
//        }
//        return true;
        String errFlag = "errmsg";
        boolean b = (errFlag.contains(response) && !"ok".equals(response));
        boolean c = (!"errcode".contains(response) && !errFlag.contains(response));
        return b||c;
    }
